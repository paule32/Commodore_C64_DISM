...
__dbase_function_label__number:
    ...
    mov dword ptr [__dbase_concat_left_4_ptr], eax
...
__dbase_strlen_done_7:
    ...
    call __dbase_malloc
    add esp, 4
    mov dword ptr [__dbase_concat_right_5_ptr], eax
    push dword ptr [__dbase_concat_right_5_len]
    push __dbase_format_buffer
    push dword ptr [__dbase_concat_right_5_ptr]
    call __dbase_memcpy
    add esp, 12
    mov eax, dword ptr [__dbase_concat_right_5_ptr]
    ...
    push dword ptr [__dbase_concat_left_4_len]
    push dword ptr [__dbase_concat_left_4_ptr]
    push dword ptr [__dbase_function_label__number_result_ptr]
    call __dbase_memcpy
    add esp, 12
    mov eax, dword ptr [__dbase_function_label__number_result_ptr]
    add eax, dword ptr [__dbase_concat_left_4_len]
    push dword ptr [__dbase_concat_right_5_len]
    push dword ptr [__dbase_concat_right_5_ptr]
    push eax
    call __dbase_memcpy
