...
__dbase_format_buffer_alloc_ok_3:
    ...
    add esp, 4
    mov dword ptr [__dbase_object_app_custom], eax
    call DBaseQtShutdownRequested
    test eax, eax
    jne __dbase_program_cleanup_1
    push 14
    push __dbase_text_1
    push dword ptr [__dbase_object_app_custom]
    call DBaseQtMenuSetText
    add esp, 12
    call DBaseQtShutdownRequested
    test eax, eax
    jne __dbase_program_cleanup_1
    mov eax, dword ptr [__dbase_object_app_custom]
    push eax
    call DBaseQtMenuCreate
    add esp, 4
    mov dword ptr [__dbase_object_app_custom_test], eax
    call DBaseQtShutdownRequested
    test eax, eax
    jne __dbase_program_cleanup_1
    push 4
    push __dbase_text_2
    push dword ptr [__dbase_object_app_custom_test]
    call DBaseQtMenuSetText
    add esp, 12
    call DBaseQtShutdownRequested
    test eax, eax
...
__dbase_text_0:
    ...
    db 71, 0
__dbase_text_1:
    db 66, 101, 110, 117, 116, 122, 101, 114, 45, 77, 101, 110, 117, 101
__dbase_text_2:
    db 84, 101, 115, 116
__dbase_text_3:
    db 77, 101, 110, 117, 101, 32, 97, 117, 115, 32, 115, 116, 97, 103, 101, 50, 52, 95, 109, 101, 110, 117, 46, 109
    db 110, 117
__dbase_text_4:
    db 13, 10
__dbase_temp_number:
...
__dbase_exit_code:
    dd 0
__dbase_object_app_custom:
    dd 0
__dbase_object_app_custom_test:
    dd 0
