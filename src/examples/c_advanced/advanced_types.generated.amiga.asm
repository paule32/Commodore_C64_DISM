...
main:
    ...
    bsr __c_print_string
    bsr PersistentCounter
    bsr __c_print_int16
    lea __c_string_4(pc),a0
    bsr __c_print_string
    bsr PersistentCounter
    bsr __c_print_int16
    lea __c_string_1(pc),a0
    bsr __c_print_string
    lea __c_string_5(pc),a0
    bsr __c_print_string
    lea -8(a6),a0
    moveq #0,d0
    move.b (a0)+,d0
...
__c_string_0: dc.b $69, $6E, $6E, $65, $72, $3D, $00
__c_string_1: dc.b $0A, $00
__c_string_2: dc.b $66, $61, $63, $74, $6F, $72, $69, $61, $6C, $3D, $00
__c_string_3: dc.b $73, $74, $61, $74, $69, $63, $3D, $00
__c_string_4: dc.b $2C, $00
__c_string_5: dc.b $73, $65, $74, $3D, $00
__c_string_6: dc.b $73, $74, $72, $75, $63, $74, $3D, $00
...
SetEmpty:
    ...
    move.l sp,a6
    move.w #$0000,d0
    bra __cmod_set_runtime_0c6f687a_return_setempty_1
    moveq #0,d0
...
SetOf:
    ...
    move.w (sp)+,d0
    cmp.w d1,d0
    blt __cmod_set_runtime_0c6f687a_cmp_true_11
    moveq #0,d0
    bra __cmod_set_runtime_0c6f687a_cmp_end_12
__cmod_set_runtime_0c6f687a_cmp_true_11:
    moveq #1,d0
__cmod_set_runtime_0c6f687a_cmp_end_12:
    move.w d0,-(sp)
    lea 8(a6),a0
    moveq #0,d0
    move.b (a0)+,d0
    ...
    move.w (sp)+,d0
    cmp.w d1,d0
    bgt __cmod_set_runtime_0c6f687a_cmp_true_13
    moveq #0,d0
    bra __cmod_set_runtime_0c6f687a_cmp_end_14
__cmod_set_runtime_0c6f687a_cmp_true_13:
    moveq #1,d0
__cmod_set_runtime_0c6f687a_cmp_end_14:
    move.w d0,d1
    move.w (sp)+,d0
    or.w d1,d0
    tst.w d0
    beq __cmod_set_runtime_0c6f687a_if_else_9
    move.w #$0000,d0
    bra __cmod_set_runtime_0c6f687a_return_setof_2
...
__cmod_set_runtime_0c6f687a_if_end_10:
    ...
    move.b d1,(a0)+
    move.b d0,(a0)
__cmod_set_runtime_0c6f687a_while_condition_15:
    lea 8(a6),a0
    moveq #0,d0
    move.b (a0)+,d0
    lsl.w #8,d0
    ...
    move.w (sp)+,d0
    cmp.w d1,d0
    bgt __cmod_set_runtime_0c6f687a_cmp_true_17
    moveq #0,d0
    bra __cmod_set_runtime_0c6f687a_cmp_end_18
__cmod_set_runtime_0c6f687a_cmp_true_17:
    moveq #1,d0
__cmod_set_runtime_0c6f687a_cmp_end_18:
    tst.w d0
    beq __cmod_set_runtime_0c6f687a_while_end_16
    lea -2(a6),a0
    moveq #0,d0
    move.b (a0)+,d0
    lsl.w #8,d0
    ...
    move.b d1,(a0)+
    move.b d0,(a0)
    jmp __cmod_set_runtime_0c6f687a_while_condition_15
__cmod_set_runtime_0c6f687a_while_end_16:
    lea -2(a6),a0
    moveq #0,d0
    move.b (a0)+,d0
    lsl.w #8,d0
...
SetAdd:
    ...
    move.w (sp)+,d0
    or.w d1,d0
    bra __cmod_set_runtime_0c6f687a_return_setadd_3
    moveq #0,d0
...
SetRemove:
    ...
    move.w (sp)+,d0
    and.w d1,d0
    bra __cmod_set_runtime_0c6f687a_return_setremove_4
    moveq #0,d0
...
SetUnion:
    ...
    move.w (sp)+,d0
    or.w d1,d0
    bra __cmod_set_runtime_0c6f687a_return_setunion_5
    moveq #0,d0
...
SetIntersection:
    ...
    move.w (sp)+,d0
    and.w d1,d0
    bra __cmod_set_runtime_0c6f687a_return_setintersection_6
    moveq #0,d0
...
SetDifference:
    ...
    move.w (sp)+,d0
    and.w d1,d0
    bra __cmod_set_runtime_0c6f687a_return_setdifference_7
    moveq #0,d0
...
SetContains:
    ...
    move.w (sp)+,d0
    cmp.w d1,d0
    bne __cmod_set_runtime_0c6f687a_cmp_true_19
    moveq #0,d0
    bra __cmod_set_runtime_0c6f687a_cmp_end_20
__cmod_set_runtime_0c6f687a_cmp_true_19:
    moveq #1,d0
__cmod_set_runtime_0c6f687a_cmp_end_20:
    bra __cmod_set_runtime_0c6f687a_return_setcontains_8
    moveq #0,d0
...
; Wartet auf den sicheren unteren Vertical-Blank-Bereich
__cmod_set_runtime_0c6f687a_wait_safe_line:
    move.l #$00DFF000,a0
__cmod_set_runtime_0c6f687a_wait_safe_line_loop:
    move.w $0006(a0),d0 ; VHPOSR
    andi.w #$FF00,d0
    cmpi.w #$F500,d0
    bcs __cmod_set_runtime_0c6f687a_wait_safe_line_loop
    rts

; Copper-Liste bei $10000 lädt den Text-Bitplane-Zeiger in jedem Frame neu
__cmod_set_runtime_0c6f687a_install_text_copper:
    move.l #$00010000,a1
    move.l #$008E2C81,(a1)+
    move.l #$0090F4C1,(a1)+
    move.l #$00920038,(a1)+
...
; Direkte OCS-Bildschirminitialisierung, 320x200, 1 Bitplane
__cmod_set_runtime_0c6f687a_screen_init:
    bsr __cmod_set_runtime_0c6f687a_wait_safe_line
    move.l #$00DFF000,a0
    move.w #$7FFF,$009A(a0) ; INTENA: Interrupts aus
    move.w #$7FFF,$0096(a0) ; DMACON: DMA aus
    bsr __cmod_set_runtime_0c6f687a_clear_screen
    bsr __cmod_set_runtime_0c6f687a_install_text_copper
    move.l #$00DFF000,a0
    move.l #$00010000,d0
    move.l d0,$0080(a0) ; COP1LCH/COP1LCL
    move.w #$0000,$0088(a0) ; COPJMP1
    ...
    rts
; Löscht 8000 Bytes Text-Bitplane-RAM und setzt den Cursor zurück
__cmod_set_runtime_0c6f687a_clear_screen:
    move.l #$00018000,a0
    move.w #$07D0,d0
__cmod_set_runtime_0c6f687a_clear_screen_loop:
    clr.l (a0)+
    subq.w #1,d0
    bne __cmod_set_runtime_0c6f687a_clear_screen_loop
    lea __cmod_set_runtime_0c6f687a_cursor_x(pc),a0
    clr.b (a0)
    lea __cmod_set_runtime_0c6f687a_cursor_y(pc),a0
    clr.b (a0)
    rts

    even
; Direkte Amiga-Bildschirmlaufzeitdaten
__cmod_set_runtime_0c6f687a_cursor_x: dc.b 0
__cmod_set_runtime_0c6f687a_cursor_y: dc.b 0
__cmod_set_runtime_0c6f687a_int_buffer: ds.b 8
__cmod_set_runtime_0c6f687a_int_buffer_end:
...
Factorial:
    ...
    move.w (sp)+,d0
    cmp.w d1,d0
    ble __cmod_recursive_module_9379dde2_cmp_true_5
    moveq #0,d0
    bra __cmod_recursive_module_9379dde2_cmp_end_6
__cmod_recursive_module_9379dde2_cmp_true_5:
    moveq #1,d0
__cmod_recursive_module_9379dde2_cmp_end_6:
    tst.w d0
    beq __cmod_recursive_module_9379dde2_if_else_3
    move.w #$0001,d0
    bra __cmod_recursive_module_9379dde2_return_factorial_1
...
xdef PersistentCounter
PersistentCounter:
    move.l a6,-(sp)
    move.l sp,a6
    lea __cmod_recursive_module_9379dde2_static_persistentcounter___c_local_persistentcounter_2_counter_0(pc),a0
    moveq #0,d0
    move.b (a0)+,d0
    lsl.w #8,d0
    move.b (a0),d0
    ...
    lsl.w #8,d0
    move.b (a0),d0
    bra __cmod_recursive_module_9379dde2_return_persistentcounter_2
    moveq #0,d0
...
; Wartet auf den sicheren unteren Vertical-Blank-Bereich
__cmod_recursive_module_9379dde2_wait_safe_line:
    move.l #$00DFF000,a0
__cmod_recursive_module_9379dde2_wait_safe_line_loop:
    move.w $0006(a0),d0 ; VHPOSR
    andi.w #$FF00,d0
    cmpi.w #$F500,d0
    bcs __cmod_recursive_module_9379dde2_wait_safe_line_loop
    rts

; Copper-Liste bei $10000 lädt den Text-Bitplane-Zeiger in jedem Frame neu
__cmod_recursive_module_9379dde2_install_text_copper:
    move.l #$00010000,a1
    move.l #$008E2C81,(a1)+
    move.l #$0090F4C1,(a1)+
    move.l #$00920038,(a1)+
...
; Direkte OCS-Bildschirminitialisierung, 320x200, 1 Bitplane
__cmod_recursive_module_9379dde2_screen_init:
    bsr __cmod_recursive_module_9379dde2_wait_safe_line
    move.l #$00DFF000,a0
    move.w #$7FFF,$009A(a0) ; INTENA: Interrupts aus
    move.w #$7FFF,$0096(a0) ; DMACON: DMA aus
    bsr __cmod_recursive_module_9379dde2_clear_screen
    bsr __cmod_recursive_module_9379dde2_install_text_copper
    move.l #$00DFF000,a0
    move.l #$00010000,d0
    move.l d0,$0080(a0) ; COP1LCH/COP1LCL
    move.w #$0000,$0088(a0) ; COPJMP1
    ...
    rts
; Löscht 8000 Bytes Text-Bitplane-RAM und setzt den Cursor zurück
__cmod_recursive_module_9379dde2_clear_screen:
    move.l #$00018000,a0
    move.w #$07D0,d0
__cmod_recursive_module_9379dde2_clear_screen_loop:
    clr.l (a0)+
    subq.w #1,d0
    bne __cmod_recursive_module_9379dde2_clear_screen_loop
    lea __cmod_recursive_module_9379dde2_cursor_x(pc),a0
    clr.b (a0)
    lea __cmod_recursive_module_9379dde2_cursor_y(pc),a0
    clr.b (a0)
    rts

    even
; Direkte Amiga-Bildschirmlaufzeitdaten
__cmod_recursive_module_9379dde2_cursor_x: dc.b 0
__cmod_recursive_module_9379dde2_cursor_y: dc.b 0
__cmod_recursive_module_9379dde2_int_buffer: ds.b 8
__cmod_recursive_module_9379dde2_int_buffer_end:

; C-Variablen
    even
__cmod_recursive_module_9379dde2_static_persistentcounter___c_local_persistentcounter_2_counter_0: dc.w $0028 ; intern: integer
