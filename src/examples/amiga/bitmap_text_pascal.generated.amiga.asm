...
; Programm: BitmapTextPascal
.bootable
section code,code
xdef _start
_start:
    move.l #$0007FFFC,sp
    bsr __pas_screen_init
    move.w #$00F0,d0
    move.w d0,-(sp)
    move.w #$0000,d0
    move.w d0,d1
    move.w (sp)+,d0
    bsr __pas_set_text_color
    lea __pas_string_0(pc),a0
    bsr __pas_print_string
    lea __pas_string_1(pc),a0
    bsr __pas_print_string
    lea __pas_string_2(pc),a0
    bsr __pas_print_string
    move.w #$0005,d0
    bsr __pas_print_int16
    lea __pas_string_1(pc),a0
    bsr __pas_print_string
    lea __pas_string_3(pc),a0
    bsr __pas_print_string
    lea __pas_string_1(pc),a0
    bsr __pas_print_string
...
__pas_clear_screen:
    move.l #$00010000,a0
    move.w #$0A00,d0
__pas_clear_screen_loop:
    clr.l (a0)+
    subq.w #1,d0
    bne __pas_clear_screen_loop
    lea __pas_cursor_x(pc),a0
    clr.b (a0)
    lea __pas_cursor_y(pc),a0
    clr.b (a0)
    rts

; D0.W = Vordergrund-$RGB, D1.W = Hintergrund-$RGB
__pas_set_text_color:
    andi.w #$0FFF,d0
    andi.w #$0FFF,d1
    move.l #$00DFF000,a0
    move.w d1,$0180(a0)
...
__pas_print_char:
    cmpi.w #$000A,d0
    beq __pas_print_char_newline
    cmpi.w #$000D,d0
    beq __pas_print_char_newline
    cmpi.w #$0020,d0
    bcs __pas_print_char_substitute
    cmpi.w #$007F,d0
    bcs __pas_print_char_glyph
__pas_print_char_substitute:
    move.w #$003F,d0
__pas_print_char_glyph:
    subi.w #$0020,d0
    mulu.w #$0008,d0
    lea __pas_font_8x8(pc),a2
    adda.w d0,a2
    lea __pas_cursor_y(pc),a1
    moveq #0,d1
    move.b (a1),d1
    mulu.w #$0140,d1
    move.l #$00010000,a1
    ...
    move.b (a0),d0
    cmpi.w #$0028,d0
    bcs __pas_print_char_done
__pas_print_char_newline:
    lea __pas_cursor_x(pc),a0
    clr.b (a0)
    lea __pas_cursor_y(pc),a0
    addq.b #1,(a0)
...
__pas_print_string_loop:
    ...
    bsr __pas_print_char
    bra __pas_print_string_loop
...
__pas_cursor_x: dc.b 0
__pas_cursor_y: dc.b 0
__pas_int_buffer: ds.b 8
__pas_int_buffer_end:

; Nullterminierte Amiga-Latin-1-Zeichenketten
__pas_string_0: dc.b $41, $6D, $69, $67, $61, $20, $35, $30, $30, $20, $42, $69, $74, $6D, $61, $70, $2D, $54, $65, $78, $74, $00
__pas_string_1: dc.b $0A, $00
__pas_string_2: dc.b $50, $61, $73, $63, $61, $6C, $20, $57, $72, $69, $74, $65, $4C, $6E, $3A, $20, $43, $6F, $75, $6E, $74, $65, $72, $20, $3D, $20, $00
__pas_string_3: dc.b $46, $61, $72, $62, $65, $3A, $20, $67, $72, $75, $65, $6E, $20, $61, $75, $66, $20, $73, $63, $68, $77, $61, $72, $7A, $00
