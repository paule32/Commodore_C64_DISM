...
extern __pas_method_tapplication_create
extern __pas_method_tapplication_destroy
extern __pas_method_tapplication_gethandle
...
align 4
__pas_unit_Windows_fmt_s: db 37, 115, 0
__pas_unit_Windows_fmt_d: db 37, 100, 0
__pas_unit_Windows_fmt_c: db 37, 99, 0
__pas_unit_Windows_newline: db 13, 10, 0
__pas_unit_Windows_clear_sequence: db 27, 91, 50, 74, 27, 91, 72, 0
__pas_unit_Windows_range_message: db 82, 97, 110, 103, 101, 32, 101, 114, 114, 111, 114, 13, 10, 0
