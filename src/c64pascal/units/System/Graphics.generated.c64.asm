...
; Quelldatei: /mnt/data/d64_dism_c64_primitives_fix/d64_dism_c64_vic_charrom_screen_fix/c64pascal/units/System/Graphics.c64.c

; Compiler-Laufzeitdaten
__pas_unit_c_rt_value:      .word 0
__pas_unit_c_rt_remainder:  .word 0
__pas_unit_c_rt_count:      .byte 0
__pas_unit_c_rt_mode:       .byte 0

; C-Stackframe-Zeiger
__pas_unit_c_unit_c_frame_pointer: .byte 0

; --- statisch gelinktes C-Modul: graphics_c64.asm ---
; ---------------------------------------------------------------------------
...
; ; Pascal-PUI-Aliase fuer das getrennt kompilierte C-Modul
