...
{
  C64: VIC-II-Multicolor-Bitmap. Die API verwendet weiterhin X=0..319;
  zwei benachbarte X-Koordinaten teilen sich ein zweifach breites Farbpixel.
  Amiga: echte 320x200-Pixel in vier Bitplanes.
}
